            ...
            <div class="md:w-2/3">
              <div class="p-4">
                <div class="mb-2">
                  ...
                  >
                    <div class="flex-auto">Wie mache ich das ?</div>
                    <div class="px-2 mt-1">
                      <div style>
                        <svg
                ...
                <div class="mb-2">
                  ...
                  <div class="p-2 text-justify text-left text-gray-800 mb-5 bg-white" style>
                    ...
                    <span class="font-bold">adipisicing elit</span>. Mollitia temporibus doloremque non eligendi unde ipsam? Voluptatibus, suscipit deserunt quidem delectus perferendis velit molestias, veritatis officia fugiat cumque quaerat earum adipisci?
                  </div>
                </div>
                <div class="mb-2">
                  <div
